...
public class PrincipleFirst {
    ...
    @Expose
    public List<PrincipleFirst> childList = null;
    ...
    public List<PrincipleFirst> getChildList() {
        return childList;
    }

    public void setChildList(List<PrincipleFirst> childList) {
