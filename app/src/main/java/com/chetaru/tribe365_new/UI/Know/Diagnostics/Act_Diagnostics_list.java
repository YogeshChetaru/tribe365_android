...
import com.chetaru.tribe365_new.Adapter.Diagnostics.Ad_Diagnostics_list;
...
public class Act_Diagnostics_list extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_diagnostic_list);
        try {
    ...
    private void inti() {
        ...
        Type type = new TypeToken<ArrayList<ModelDiagnosticsQusList>>() {
        }.getType();
        call_QuestionList();
    }
...
//                            }
                ...
                Ad_Diagnostics_list ad_diagnostics_list = new Ad_Diagnostics_list(li_diagnostics, mContext);
        ...
        map.put("", "");
        baseRequest.callAPIGET(1, map, getString(R.string.api_getDiagnosticQuestionList));
    }
    ...
    public void call_AnswerList() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int requestCode, String Json, Object object) {
                ...
                editor.commit();
                //------clear------------------
                Toast.makeText(mContext, "Diagnostic answer added successfully.", Toast.LENGTH_SHORT).show();
                if (checklist != null) {
...
//        NeutralButton.setTextColor(getResources().getColor(R.color.cardback));
    ...
    public int getLayoutId() {
        return R.layout.act_diagnostic_list;
    }
