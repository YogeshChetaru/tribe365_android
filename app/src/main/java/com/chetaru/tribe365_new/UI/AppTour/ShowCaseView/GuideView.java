...
import com.chetaru.tribe365_new.UI.AppTour.ShowCaseView.Config.Gravity;
...
import com.chetaru.tribe365_new.UI.AppTour.ShowCaseView.Listener.SkipListener;
...
public class GuideView extends FrameLayout implements SkipListener {

    static final String TAG = "GuideView";

    private static final int INDICATOR_HEIGHT = 6;
    private static final int MESSAGE_VIEW_PADDING = 2;
    ...
    private static final int LINE_INDICATOR_WIDTH_SIZE = 1;
    private static final int STROKE_CIRCLE_INDICATOR_SIZE = 3;
    private static final int RADIUS_SIZE_TARGET_RECT = 25;
    private static final int MARGIN_INDICATOR = 5;

    //private static final int BACKGROUND_COLOR              = 0x99000000;
    private static final int BACKGROUND_COLOR = 0xcc474747;
    ...
    private final Paint targetPaint = new Paint(Paint.HINTING_ON);
    ...
    private GuideView(Context context, View view) {
        ...
        mMessageView.setColor(context.getResources().getColor(R.color.colorPrimary));

        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT);
        if (mOrientation==orientation.landscape) {
            params.setMargins(150, 0, 140, 20);
        }
    ...
    private Point resolveMessageViewLocation() {
        ...
        if (xMessageView + mMessageView.getWidth() > getWidth())
            xMessageView = (getWidth()) - (mMessageView.getWidth() + (int) (targetRect.right));
        if (xMessageView < 0)
            xMessageView = 0;


        if (mGravity != Gravity.auto) {
    ...
    public void setButtonText(String buttonText) {
        mMessageView.skipButton.setText(buttonText);
    }


    public void setNextButton(String nextButton) {
        mMessageView.nextButton.setText(nextButton);
    }


    public void setButtonBackground(Drawable drawable) {
        mMessageView.skipButton.setBackground(drawable);
    }

    public void setButtonTextColor(@ColorInt int color) {
        mMessageView.skipButton.setTextColor(color);
    }
    ...
    public static class Builder {
        ...
        /////new variable added in build layout

        private int titleGravity;
        private int contentGravity;
        private int buttonGravity;
        private String buttonText, nextButton;
        ...
        public Builder setOrientation(orientation type){
        ...
        public Builder setNextButtonText(String buttonText) {
        ...
        public GuideView build() {
            ...
            guideView.mOrientation=orientation;
            ...
            ////add new methods for handel button or gravity and padding
            ...
            if (nextButton != null) {
                guideView.setNextButton(nextButton);
            }
