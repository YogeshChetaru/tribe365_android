...
public class Adap_SOT_Questionlist extends RecyclerView.Adapter<Adap_SOT_Questionlist.ViewHolder> {
    ...
    public Adap_SOT_Questionlist(ArrayList<ModelSOTQusList> list_modelSOTQusListQuestions, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sot_row_questionlist, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.chk_sot_ques1.setOnCheckedChangeListener(null);
