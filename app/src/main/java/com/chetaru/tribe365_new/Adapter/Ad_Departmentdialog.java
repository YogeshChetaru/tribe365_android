...
public class Ad_Departmentdialog extends RecyclerView.Adapter<Ad_Departmentdialog.ViewHolder> {

    List<Department> list = new ArrayList<>();

    List<ModelDepartmentList> ModelDeplist = new ArrayList<>();
    private Context context;


    public Ad_Departmentdialog(List<Department> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        //holder.tv_tier.setText(list.get(position).getName());
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tv_tier;
        private RowTierListBinding itemBinding;
