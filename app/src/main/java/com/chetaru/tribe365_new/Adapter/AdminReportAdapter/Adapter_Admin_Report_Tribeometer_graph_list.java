...
public class Adapter_Admin_Report_Tribeometer_graph_list extends RecyclerView.Adapter<Adapter_Admin_Report_Tribeometer_graph_list.ViewHolder> {


    List<ModelTribeometerGraph> list = new ArrayList<>();
    List<Float> li_score_sort = new ArrayList<>();
    private Context context;

    public Adapter_Admin_Report_Tribeometer_graph_list(List<ModelTribeometerGraph> list, Context context) {
        this.list = list;
