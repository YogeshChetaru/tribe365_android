...
public class Ad_Update_Diagnostics_list extends RecyclerView.Adapter<Ad_Update_Diagnostics_list.ViewHolder> {

    List<ModelUpdateDiagnostics> list = new ArrayList<>();
    private Context context;


    public Ad_Update_Diagnostics_list(List<ModelUpdateDiagnostics> list, Context context) {
        this.list = list;
    ...
    @Override
    public Ad_Update_Diagnostics_list.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_diagnostic_list, parent, false);
        return new Ad_Update_Diagnostics_list.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(final Ad_Update_Diagnostics_list.ViewHolder holder, final int position) {
