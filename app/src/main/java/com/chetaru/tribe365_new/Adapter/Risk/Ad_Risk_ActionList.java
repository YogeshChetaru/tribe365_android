...
public class Ad_Risk_ActionList extends RecyclerView.Adapter<Ad_Risk_ActionList.ViewHolder> {
    ...
    public riskActionListener mListener;

    public Ad_Risk_ActionList(ArrayList<ModelACtionList> list, int riskId,Context context, riskActionListener mListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (sessionParam.role.equalsIgnoreCase("3")) {
            holder.swipe_layout.setLockDrag(!sessionParam.id.equals(list.get(position).getUserId()));
        }
        try{
            if (list.get(position).getLinkedActionOffloads() != null) {
                holder.tv_linked_offloads.setText(list.get(position).getLinkedActionOffloads() + "");
                holder.ll_offloads.setVisibility(View.GONE);
            }else {
                holder.ll_offloads.setVisibility(View.GONE);
            }
        }catch (Exception e){
        ...
        if (position==0) {
            mListener.riskAppTourClick(R.id.iv_chat, holder.itemView, list.get(position));
        }
        ...
        if (list.get(position).getOrgStatus().equalsIgnoreCase("STARTED")) {
            holder.iv_status.setImageDrawable(context.getResources().getDrawable(R.drawable.started));
            holder.tv_started.setBackgroundColor(context.getResources().getColor(R.color.segmentblock));
            holder.tv_started.setTextColor(context.getResources().getColor(R.color.white));

            holder.tv_complete.setBackgroundColor(context.getResources().getColor(R.color.white));
            holder.tv_complete.setTextColor(context.getResources().getColor(R.color.textcolor));
            holder.tv_notstarted.setBackgroundColor(context.getResources().getColor(R.color.white));
            holder.tv_notstarted.setTextColor(context.getResources().getColor(R.color.textcolor));

            if (holder.ll_status.isShown()) {
                holder.ll_status.setVisibility(View.GONE);
            }
        }
        if (list.get(position).getOrgStatus().equalsIgnoreCase("COMPLETED")) {
            holder.iv_status.setImageDrawable(context.getResources().getDrawable(R.drawable.complete));
            holder.tv_complete.setBackgroundColor(context.getResources().getColor(R.color.segmentblock));
            holder.tv_complete.setTextColor(context.getResources().getColor(R.color.white));

            holder.tv_started.setBackgroundColor(context.getResources().getColor(R.color.white));
            holder.tv_started.setTextColor(context.getResources().getColor(R.color.textcolor));
            holder.tv_notstarted.setBackgroundColor(context.getResources().getColor(R.color.white));
            holder.tv_notstarted.setTextColor(context.getResources().getColor(R.color.textcolor));
        ...
        if (list.get(position).getOrgStatus().equalsIgnoreCase("NOT STARTED")) {
            holder.iv_status.setImageDrawable(context.getResources().getDrawable(R.drawable.notstarted));
            holder.tv_notstarted.setBackgroundColor(context.getResources().getColor(R.color.segmentblock));
            holder.tv_notstarted.setTextColor(context.getResources().getColor(R.color.white));
        ...
        holder.iv_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.startActivity(new Intent(context, Act_ActionComment.class)
                        ...
                        .putExtra("riskId", riskId)
                        .putExtra("theme", holder.tv_themes.getText().toString()));
            }
        });
        ...
        holder.iv_editScroll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        holder.tv_started.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                index = position;
                if (!list.get(position).getOrgStatus().equalsIgnoreCase(holder.tv_started.getText().toString())) {
                    holder.tv_started.setBackgroundColor(context.getResources().getColor(R.color.segmentblock));
                    holder.tv_started.setTextColor(context.getResources().getColor(R.color.white));
        ...
        holder.tv_complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                index = position;
                if (!list.get(position).getOrgStatus().equalsIgnoreCase(holder.tv_complete.getText().toString() + "d")) {
                    holder.tv_started.setBackgroundColor(context.getResources().getColor(R.color.white));
                    holder.tv_started.setTextColor(context.getResources().getColor(R.color.textcolor));
        ...
        holder.tv_notstarted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (!list.get(position).getOrgStatus().equalsIgnoreCase(holder.tv_notstarted.getText().toString())) {
                    holder.tv_started.setBackgroundColor(context.getResources().getColor(R.color.white));
                    holder.tv_started.setTextColor(context.getResources().getColor(R.color.textcolor));
        ...
        if (list.get(position).getmThemes().size() > 0) {
            ...
            holder.tv_themes.setText(themesSplited);
        } else {
            holder.tv_themes.setText("");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout ll_status, ll_theme,ll_offloads;
        ...
        public ViewHolder(View v) {
            ...
            ll_offloads = v.findViewById(R.id.ll_offloads);
            tv_linked_offloads= v.findViewById(R.id.tv_linked_offloads);
        }
    }

    public interface riskActionListener{
        void riskAppTourClick(int viewId, View view, ModelACtionList list);
    }
