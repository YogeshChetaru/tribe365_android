...
public class Adapter_Diagnostics_graph_list extends RecyclerView.Adapter<Adapter_Diagnostics_graph_list.ViewHolder> {
    ...
    public Adapter_Diagnostics_graph_list(List<ModelDiagnosticReport> list, List<Float> li_score_sort, Context context) {
        this.list = list;
