...
public class Ad_TeamRole extends RecyclerView.Adapter<Ad_TeamRole.ViewHolder> {

    List<String> teamRoleList;
    Context mContext;

    public Ad_TeamRole(List<String> teamRoleList, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemBinding.rowNameTv.setText(teamRoleList.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(RowOptionsListBinding itemBinding) {
