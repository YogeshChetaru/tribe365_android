...
public class Ad_Diagnostics_list extends RecyclerView.Adapter<Ad_Diagnostics_list.ViewHolder> {

    List<ModelDiagnosticsQusList> list = new ArrayList<>();
    private Context context;


    public Ad_Diagnostics_list(List<ModelDiagnosticsQusList> list, Context context) {
        this.list = list;
    ...
    @Override
    public Ad_Diagnostics_list.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_diagnostic_list, parent, false);
        return new Ad_Diagnostics_list.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(final Ad_Diagnostics_list.ViewHolder holder, final int position) {
