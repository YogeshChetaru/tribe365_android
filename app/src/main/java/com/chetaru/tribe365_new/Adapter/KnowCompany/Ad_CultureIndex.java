...
public class Ad_CultureIndex extends RecyclerView.Adapter<Ad_CultureIndex.ViewHolder> {
    ...
    public Ad_CultureIndex(List<ModelCultureIndex> list, Context context) {
        this.list = list;
